...
const SideDrawer = () => {
    ...
    return (
        <>
            ...
            >
                {/* Search User Section */}
                {user.isAgent && <Tooltip label="Search users to chat" hasArrow placement="bottom-end">
                ...
                {/* App Name Section */}
                <Image width='80px' src={BranchInternational} alt='' />
            ...
            {user.isAgent && <Drawer placement="left" isOpen={isOpen} onClose={onClose}>
                <DrawerOverlay />
                <DrawerContent>
                    <DrawerCloseButton />
